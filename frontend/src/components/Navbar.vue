      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        ...
        <ul v-else class="navbar-nav">
          ...
          <template v-else-if="userRole === 'employer'">
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/profile/jobs">  MyJobs</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/profile/jobs/create">Create Job </router-link>
            </li>
            <li class="nav-item">
              <button @click="logout" class="btn btn-outline-danger ms-2">Logout</button>
            </li>
          ...
          <template v-else-if="userRole === 'candidate'">
            <li class="nav-item">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
              <router-link class="nav-link" to="/job"> Apply jobs </router-link>
            </li>
