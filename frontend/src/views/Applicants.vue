    ...
    <div v-else>
      <div class="card mb-4">
        ...
        <div class="list-group list-group-flush">
          <div v-for="application in applicants" :key="application.id" class="list-group-item">
            <div class="row align-items-center">
              <!-- Applicant Info -->
              <div class="col-md-3">
                <h5 class="mb-1">{{ application.candidate && application.candidate.name ? application.candidate.name :
                  'Unknown' }}</h5>
                <p class="mb-0 text-muted small">{{ application.candidate && application.candidate.email ?
              ...
              <!-- Resume -->
              <div class="col-md-2">
                <button v-if="application.resume" @click="downloadResume(application.resume)"
              ...
              <div class="col-md-3">
                <div class="btn-group">
                  <button @click="openStatusModal(application)" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p v-if="selectedApplication">
              Update status for <strong>{{ selectedApplication.candidate && selectedApplication.candidate.name ?
                selectedApplication.candidate.name : 'Unknown' }}</strong>'s application.
            </p>

            <div class="d-grid gap-2">
              <button @click="updateStatus('accepted')" class="btn btn-success" :disabled="statusLoading">
                <i class="bi bi-check-circle-fill me-2"></i> Accept
              </button>

              <button @click="updateStatus('rejected')" class="btn btn-danger" :disabled="statusLoading">
                <i class="bi bi-x-circle-fill me-2"></i> Reject
              </button>

              <button @click="updateStatus('pending')" class="btn btn-warning" :disabled="statusLoading">
